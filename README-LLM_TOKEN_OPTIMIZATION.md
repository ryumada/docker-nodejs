...
|---|---|---|
| Before | 9 files | ~400 lines |
| After | 3 files | ~20 lines |
| **Reduction** | | **~95%** (further reduced by referenced ponytail instructions) |
...
| `always-create-tests.md` | `model_decision` | Only needed after editing/creating code |
| `run-npm-command.md` | `model_decision` | Only needed when running npm/npx commands |
| `test-log-compression.md` | `model_decision` | Compresses verbose Node.js/Jest test logs |
